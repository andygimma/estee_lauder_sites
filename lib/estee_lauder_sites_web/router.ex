defmodule EsteeLauderSitesWeb.Router do
  use EsteeLauderSitesWeb, :router
  ...
  if Application.compile_env(:estee_lauder_sites, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: EsteeLauderSitesWeb.Telemetry
